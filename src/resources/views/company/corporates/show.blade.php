...
<head>
    ...
    <title>フリーランス詳細（企業）- AIプロマッチ</title>
...
<body>
    ...
    <main class="main-content max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-10">
        <h1 class="page-title text-2xl md:text-3xl font-black tracking-tight">法人詳細</h1>
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 lg:gap-8">
            ...
            <aside class="panel p-5 md:p-8">
                ...
                <div class="desc">
                    この法人にスカウトを送ると、<strong>企業 × 法人</strong> のチャットスレッドが自動生成されます。
                </div>
                <div class="btn-row flex flex-col md:flex-row gap-3">
                    <a class="btn btn-primary w-full md:flex-1" href="{{ route('company.scouts.create') }}?corporate_id={{ $corporate->id }}">スカウト</a>
                    <a class="btn btn-secondary w-full md:flex-1" href="{{ route('company.corporates.index') }}">一覧へ戻る</a>
                </div>
