            ...
            <form action="#" method="post">
                <div class="grid">
                    <div class="field">
                        ...
                        <input id="title" class="input" type="text" placeholder="例: ECサイト機能拡張プロジェクト" required>
                    </div>
                    <div class="field">
                ...
                <div class="field">
                    ...
                    <textarea id="overview" class="textarea" placeholder="案件の概要を入力してください" required></textarea>
                </div>

                <div class="field">
                    <label for="work">想定業務</label>
                    <textarea id="work" class="textarea" placeholder="例: 管理画面改善 / 商品登録フロー改善 / パフォーマンス改善"></textarea>
                </div>

                <div class="grid">
                    <div class="field">
                        <label for="skills">必要スキル（自由入力）</label>
                        <input id="skills" class="input" type="text" placeholder="例: PHP, Laravel, Vue.js, MySQL">
                        <div class="help">カンマ区切り想定（ダミー表示）</div>
                    </div>
                    <div class="field">
                        <label for="reward">報酬目安</label>
                        <input id="reward" class="input" type="text" placeholder="例: 30万円〜50万円">
                        <div class="help">MVPではレンジテキストでOK</div>
                    </div>
                </div>
                ...
                <div class="grid">
                    <div class="field">
                        ...
                        <input id="period" class="input" type="text" placeholder="例: 2〜3ヶ月">
                    </div>
                    <div class="field">
                        <label for="hours">稼働時間</label>
                        <input id="hours" class="input" type="text" placeholder="例: 週10〜20時間">
                    </div>
                </div>
