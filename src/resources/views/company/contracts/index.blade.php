...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .title { font-size: 28px; font-weight: 900; margin-bottom: 0.5rem; }
        .sub { color: #6a737d; font-weight: 700; margin-bottom: 1.5rem; }
        ...
        .actions a { font-weight: 900; color:#0366d6; text-decoration:none; }
...
<main class="main">
    ...
    <p class="sub">自社が当事者の契約一覧です（スレッドに紐づきます）。</p>
            ...
            <div class="row">
                <div>
                    <div style="font-weight:900;">
                        {{ $contract->corporate->display_name ?? ($contract->corporate->corporation_name ?? '法人') }}
                        @if($contract->job)
                            / {{ $contract->job->title }}
                        @endif
                    </div>
                ...
                <div class="actions">
                    <a href="{{ route('company.contracts.show', ['contract' => $contract]) }}">表示</a>
                </div>
            </div>
        </div>
    @endforeach
